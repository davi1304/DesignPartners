...
{
    public class DetranRJVerificarPontosRepository : DetranVerificarPontosRepositoryCrawlerBase
    {
        ...
        {
            _Logger.LogDebug($"Consultando os Pontos do veículo de placa {veiculo.Placa} do estado de RJ.");
