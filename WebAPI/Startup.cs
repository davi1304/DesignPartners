...
namespace DesignPatternSamples.WebAPI
{
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
           ...
           // app.UseDetranVerificadorDebitosFactory();
            ...
            app.UseDetranVerificarPontosFactory();
    ...
    public static class ServicesPontoCollectionExtensions
    {
        public static IServiceCollection AddDependencyInjection(this IServiceCollection services)
        {
            return services
                .AddTransient<IDetranVerificarPontosService, DetranVerificarPontosServices>()
                .Decorate<IDetranVerificarPontosService, DetranVerificarPontosDecoratorCache>()
                .Decorate<IDetranVerificarPontosService, DetranVerificarPontosDecoratorLogger>()
    ...
    public static class ApplicationPontoBuilderExtensions
    {
        public static IApplicationBuilder UseDetranVerificarPontosFactory(this IApplicationBuilder app)
        {
            app.ApplicationServices.GetService<IDetranVerificarPontosFactory>()
                .Register("PE", typeof(DetranPEVerificarPontosRepository))
                .Register("RJ", typeof(DetranRJVerificarPontosRepository))
                .Register("SP", typeof(DetranSPVerificarPontosRepository))
